...
STATIC Dio_Config * Dio_PortChannels = NULL_PTR;
...
void Dio_Init(const Dio_ConfigType * ConfigPtr)
{
...

	{
		...
		Dio_PortChannels = ConfigPtr->channel; /* address of the first Channels structure --> Channels[0] */
	}
}
...
void Dio_WriteChannel(Dio_ChannelType ChannelId, Dio_LevelType Level)
{
	...
	if(FALSE == error)
	{
		...
		{
			case 0:	Port_Ptr = &(GPIOA->ODR);
		        break;
			case 1:	Port_Ptr = &(GPIOB->ODR);
		        break;
			case 2:	Port_Ptr = &(GPIOC->ODR);
		        break;
			case 3:	Port_Ptr = &(GPIOD->ODR);
		        break;
			case 4:	Port_Ptr = &(GPIOE->ODR);
		        break;
			case 5:	Port_Ptr = &(GPIOF->ODR);
		        break;
			case 6:	Port_Ptr = &(GPIOG->ODR);
		        break;
			case 7:	Port_Ptr = &(GPIOH->ODR);
		        break;
		...
		{
			/* Write Logic High */
			SET_BIT(*Port_Ptr,Dio_PortChannels[ChannelId].Pin);
		}
		else if(Level == STD_LOW)
		{
			/* Write Logic Low */
			CLEAR_BIT(*Port_Ptr,Dio_PortChannels[ChannelId].Pin);
		}
	}
	else
	{
...
Dio_LevelType Dio_ReadChannel(Dio_ChannelType ChannelId)
{
	...
	if(FALSE == error)
	{
		...
		switch(Dio_PortChannels[ChannelId].Port_Num)
		{
		  case 0:	PIN_Ptr = &(GPIOA->IDR);
		        break;
			case 1:	PIN_Ptr = &(GPIOB->IDR);
		        break;
			case 2:	PIN_Ptr = &(GPIOC->IDR);
		        break;
			case 3:	PIN_Ptr = &(GPIOD->IDR);
		        break;
			case 4:	PIN_Ptr = &(GPIOE->IDR);
		        break;
			case 5:	PIN_Ptr = &(GPIOF->IDR);
		        break;
			case 6:	PIN_Ptr = &(GPIOG->IDR);
		        break;
			case 7:	PIN_Ptr = &(GPIOH->IDR);
		        break;
		}
		/* Read the required channel */
		if(BIT_IS_SET(*PIN_Ptr,Dio_PortChannels[ChannelId].Pin))
		{
			output = STD_HIGH;
		}
		else
